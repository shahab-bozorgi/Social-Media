	 ...
	 /* AUTOSIZE */
	   ...
	   /* WYSIWYG EDITOR */
        ...
        function init_ToolbarBootstrapBindings() {
          var fonts = ['yekan','Serif', 'Sans', 'Arial', 'Arial Black', 'Courier',
		...
		function init_daterangepicker() {
			...
			var optionSet1 = {
			  ...
			  locale: {
				...
				monthNames: ['January', 'February', 'March', 'April', 'تیر', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
				firstDay: 1
			  }
			};
			...
			if ($('#echart_pie2').length ){ 
			  ...
			  echartPieCollapse.setOption({
				...
				legend: {
				  ...
				  data: [ 'نتیجه6' , 'نتیجه5' , 'نتیجه4' , 'نتیجه3' , 'نتیجه2' , 'نتیجه1']
				},
				toolbox: {
					align: 'left',
					left: '0',
			...
			if ($('#echart_donut').length ){  
			  ...
			  echartDonut.setOption({
				...
				legend: {
				  ...
				  data: ['دسترسی ', 'بازاریابی ایمیلی', 'آگهی اتحادیه', 'تبلیغات ویدئویی', 'موتور جستجو']
				},
				toolbox: {
					align: 'left',
					left: '0',
			...
			if ($('#echart_mini_pie').length ){ 
			  ...
			  echartMiniPie .setOption({
				...
				legend: {
				  ...
				  y: 45,
				  itemGap: 12,
				  data: ['68% رایانه', '29% تبلت ', '3% موبایل'],
				},
				toolbox: {
				  show: true,
				  align: 'left',
			...
			if ($('#echart_world_map').length ){ 
				  ...
				  echartMap.setOption({
					title: {
					  ...
					  subtext: 'از سازمان ملل متحد، کل جمعیت، هر دو جنس با هم، تا 1 ژوئیه',
					  x: 'center',
					  y: 'top'
					},
					tooltip: {
					...
					series: [{
					  ...
					  data: [{
						...
						name: 'سرزمین های جنوبی و قطب جنوب فرانسه',
						value: 268.065
					  }, {
						name: 'استرالیا',
						value: 22404.488
					  ...
					  nameMap: {
						...
						'French Southern and Antarctic Lands' : 'سرزمین های جنوبی و قطب جنوب فرانسه',
						...
						'United Republic of Tanzania' : 'جمهوری متحد تانزانیا',
        ...
        var option = {
		    ...
		    series : [
		        ...
		        },
		        {
		            ...
		            markPoint : {
		                data : [
		                    {name : 'پایین ترین دما هفته', value : 0, xAxis: 1, yAxis: -1.5}
		                ]
		            },
		            markLine : {
		                data : [
		                    {type : 'average', name : 'مقدار میانگین'}
		                ]
		            }
		        }
		    ],
