...
//===== Search Filter =====//
	...
	function listFilter(searchDir, list) { 
	  ...
	  input = $("<input>").attr({"class":"filterinput","type":"text","placeholder":"جستجوی مخاطبین..."});
...
jQuery(".post-comt-box textarea").on("keydown", function(event) {
	...
	if (event.keyCode == 13) {
		...
		var comment_HTML = '	<li><div class="comet-avatar"><img src="images/resources/comet-1.jpg" alt=""></div><div class="we-comment"><div class="coment-head"><h5><a href="time-line.html" title=""> حسین کیانی</a></h5><span> 1 سال پیش </span><a class="we-reply" href="#" title="Reply"><i class="fa fa-reply"></i></a></div><p>'+comment+'</p></div></li>';
